 ...
 *
 */
public class CountID extends Configured implements Tool {

  protected enum Counter {
    records
  };

  private static final Logger LOG = Logger.getLogger(CountID.class);
  ...
  public static class MyMapper extends
    ...
    public void map(Text key, StreamItemWritable value, Context context)
      ...
      String group = value.getStream_id();
      if(group==null) {
    	  group = "[missing]";
      }
      out.set(group);
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new CountID(), args);
    System.exit(res);
  }

  static int printUsage() {
    System.out
        .println(CountID.class.getName()
            + " -i input -o output \n"
